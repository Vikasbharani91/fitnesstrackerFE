...
export default function Data() {
    ...
    return (
        ...
        <div className="data-stats__container">
            ...
            { processedResults.map(([key, value]) => <li className="data-stats__health-list-item" key={key}><span className="data-stats__health-property">{key}</span>{ '  ' }<span className="data-stats__health-value">{value && typeof value === 'number' && (value/healthData.length).toFixed(2)}</span></li>) }
            </ul>
